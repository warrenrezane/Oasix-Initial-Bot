...
const LevelPerksEmbed = new EmbedBuilder()
  .setAuthor({
    name: "Oasix",
    iconURL:
  ...
  .setDescription(
    ...
    <a:blackboost:1049863370330869843> <@&1050837323127996527> **- 10,000 Casino Role income (every 3 days); Fishing**
...
module.exports = LevelPerksEmbed;
